defmodule ExWebRTC.PeerConnectionTest do
  ...
  describe "close/1" do
    test "caller" do
      ...
      refute_received {:ex_webrtc, ^pc2, {:signaling_state_change, :closed}}
      refute_received {:ex_webrtc, ^pc2, {:ice_connection_state_change, :closed}}
      refute_received {:ex_webrtc, ^pc2, {:dtls_transport_state_change, :closed}}
      refute_received {:ex_webrtc, ^pc2, {:connection_state_change, :closed}}
